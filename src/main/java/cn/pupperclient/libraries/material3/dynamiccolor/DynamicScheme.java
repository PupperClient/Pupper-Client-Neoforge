 ...
 * palettes. Requires: 1. A color. (source color) 2. A theme. (Variant) 3.
 * Whether or not its dark mode. 4. Contrast level. (-1 to 1, currently contrast
 * ratio 3.0 and 7.0)
 */
public class DynamicScheme {
    ...
    public final TonalPalette warningPalette;

	public DynamicScheme(Hct sourceColorHct, Variant variant, boolean isDark, double contrastLevel,
			TonalPalette primaryPalette, TonalPalette secondaryPalette, TonalPalette tertiaryPalette,
		...
		this(sourceColorHct, variant, isDark, contrastLevel, primaryPalette, secondaryPalette, tertiaryPalette,
				neutralPalette, neutralVariantPalette, Optional.empty());
	}

	public DynamicScheme(Hct sourceColorHct, Variant variant, boolean isDark, double contrastLevel,
			TonalPalette primaryPalette, TonalPalette secondaryPalette, TonalPalette tertiaryPalette,
			TonalPalette neutralPalette, TonalPalette neutralVariantPalette, Optional<TonalPalette> errorPalette) {
        ...
        this.warningPalette = TonalPalette.fromHueAndChroma(40.0, 80.0);
	}

	/**
	 * Given a set of hues and set of hue rotations, locate which hues the source
	 * color's hue is between, apply the rotation at the same index as the first hue
	 * in the range, and return the rotated hue.
	 *
