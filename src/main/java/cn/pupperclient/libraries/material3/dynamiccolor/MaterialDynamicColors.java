...
public final class MaterialDynamicColors {
    ...
    {
        return new DynamicColor(/* name= */ "warning", /* palette= */ (s) -> s.warningPalette, /* tone= */ (s) -> s.isDark ? 80.0 : 40.0, /* isBackground= */ true,
                /* background= */ this::highestSurface, /* secondBackground= */ null,
                /* contrastCurve= */ new ContrastCurve(3.0, 4.5, 7.0, 7.0),
                /* toneDeltaPair= */ (s) -> new ToneDeltaPair(warningContainer(), warning(), 10.0, TonePolarity.NEARER,
                        false));
    }

    private DynamicColor warningContainer() {
        return new DynamicColor(/* name= */ "warning_container", /* palette= */ (s) -> s.warningPalette, /* tone= */ (s) -> s.isDark ? 30.0 : 90.0, /* isBackground= */ true,
                /* background= */ this::highestSurface, /* secondBackground= */ null,
                /* contrastCurve= */ new ContrastCurve(1.0, 1.0, 3.0, 4.5),
                /* toneDeltaPair= */ (s) -> new ToneDeltaPair(warningContainer(), warning(), 10.0, TonePolarity.NEARER,
                        false));
