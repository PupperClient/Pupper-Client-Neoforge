...
public final class Hct {
	 ...
	 * @param chroma 0 <= chroma < ?; Informally, colorfulness. The color returned
	...
	/**
	 * Set the hue of this color. Chroma may decrease because chroma has a different
	 * maximum for any given hue and tone.
	 *
	 ...
	 *
	 * <p>
	 * Colors change appearance. They look different with lights on versus off, the
	 * same color, as in hex code, on white looks different when on black. This is
	 * called color relativity, most famously explicated by Josef Albers in
	 * Interaction of Color.
	 *
	 * <p>
	 * In color science, color appearance models can account for this and calculate
	 * the appearance of a color in different settings. HCT is based on CAM16, a
	 * color appearance model, and uses it to make these calculations.
	 *
	 * <p>
	...
	public Hct inViewingConditions(ViewingConditions vc) {
		...
		Cam16 recastInVc = Cam16.fromXyzInViewingConditions(viewedInVc[0], viewedInVc[1], viewedInVc[2],
