...
package cn.pupperclient.libraries.material3.palettes;
...
public final class TonalPalette {
	...
	/**
	 * Create an ARGB color with HCT hue and chroma of this Tones instance, and the
	 * provided HCT tone.
	 *
	...
	/**
	 * Given a tone, use hue and chroma of palette to create a color, and return it
	 * as HCT.
	 */
	...
	/**
	 * The chroma of the Tonal Palette, in HCT. Ranges from 0 to ~130 (for sRGB
	 * gamut).
	 */
	...
	private static final class KeyColor {
		...
		/**
		 * Creates a key color from a [hue] and a [chroma]. The key color is the first
		 * tone, starting from T50, matching the given hue and chroma.
		 *
