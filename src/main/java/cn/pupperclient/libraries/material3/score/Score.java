...
package cn.pupperclient.libraries.material3.score;
...
public final class Score {
	 ...
	 *
	 * @param colorsToPopulation map with keys of colors and values of how often the
	 ...
	 * @return Colors sorted by suitability for a UI theme. The most suitable color
	 *         is the first item, the least suitable is the last. There will always
	 *         be at least one color returned. If all the input colors were not
