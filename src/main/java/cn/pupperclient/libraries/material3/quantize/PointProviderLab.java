...
public final class PointProviderLab implements PointProvider {
	 ...
	 * This method is used by quantization algorithms to compare distance, and the
	 * relative ordering is the same, with or without a square root.
	 *
	 * <p>
	 * This relatively minor optimization is helpful because this method is called
	 * at least once for each pixel in an image.
	 */
	@Override
