...
/**
 * JustFLAC - Free Lossless Audio Codec library Copyright (C) 2013 Dmitriy
 * Rogatkin
 * 
 * BSD license
 */
public class EntropyPartitionedRice2 extends EntropyCodingMethod {
	...
	void readResidual(BitInputStream is, int predictorOrder, int partitionOrder, Header header, int[] residual)
		...
		// System.err.printf("Allocating %d or %d predict %d bs: %d%n", partitionOrder,
		// partitionSamples, predictorOrder, header.blockSize);
		if (predictorOrder == 0) {
