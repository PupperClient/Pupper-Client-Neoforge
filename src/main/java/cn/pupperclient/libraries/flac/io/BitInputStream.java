...
public class BitInputStream {
	...
	// private static final long[] MASK32 = new long[]{0, 0x0000000000000001,
	// 0x0000000000000003, 0x0000000000000007, 0x000000000000000F,
	// 0x000000000000001F, 0x000000000000003F, 0x000000000000007F,
	// 0x00000000000000FF, 0x00000000000001FF, 0x00000000000003FF,
	// 0x00000000000007FF, 0x0000000000000FFF, 0x0000000000001FFF,
	// 0x0000000000003FFF, 0x0000000000007FFF, 0x000000000000FFFF,
	// 0x000000000001FFFF, 0x000000000003FFFF, 0x000000000007FFFF,
	// 0x00000000000FFFFF, 0x00000000001FFFFF, 0x00000000003FFFFF,
	// 0x00000000007FFFFF, 0x0000000000FFFFFF, 0x0000000001FFFFFF,
	// 0x0000000003FFFFFF, 0x0000000007FFFFFF, 0x000000000FFFFFFF,
	// 0x000000001FFFFFFF, 0x000000003FFFFFFF, 0x000000007FFFFFFF,
	// 0x00000000FFFFFFFF, 0x00000001FFFFFFFFL,
	// 0x00000003FFFFFFFFL, 0x00000007FFFFFFFFL, 0x0000000FFFFFFFFFL,
	// 0x0000001FFFFFFFFFL, 0x0000003FFFFFFFFFL,
	...
	// 0x00007FFFFFFFFFFFL, 0x0000FFFFFFFFFFFFL,
	...
	// 0x01FFFFFFFFFFFFFFL, 0x03FFFFFFFFFFFFFFL,
	...
	// int newCapacity = (buffer.length + minBlurbsToAdd + BUFFER_CHUNK_SIZE - 1) /
	// BUFFER_CHUNK_SIZE;
	// resize(newCapacity);
	// }
	...
	/**
	 * read a bit into an integer value. The bits of the input integer are shifted
	 * left and the read bit is placed into bit 0.
	 * 
	...
	/**
	 * peek at the next bit and add it to the input integer. The bits of the input
	 * integer are shifted left and the read bit is placed into bit 0.
	 * 
	...
	/**
	 * read a bit into a long value. The bits of the input long are shifted left and
	 * the read bit is placed into bit 0.
	 * 
	...
	public void readByteBlockAlignedNoCRC(byte[] val, int nvals) throws IOException {
		...
		while (nvals > 0) {
			...
			if (chunk <= 0) {
				...
				if (val != null)
					System.arraycopy(buffer, getByte, val, destlength - nvals, chunk);
				nvals -= chunk;
				getByte += chunk;
	...
	/**
	 * read UTF8 integer. on return, if *val == 0xffffffff then the utf-8 sequence
	...
	/**
	 * read UTF long. on return, if *val == 0xffffffffffffffff then the utf-8
	 * sequence was invalid, but the return value will be true
	 * 
	 * @param raw The raw bytes read (output). If null, no bytes are returned
