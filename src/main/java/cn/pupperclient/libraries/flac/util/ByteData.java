...
public class ByteData {
	...
	/**
	 * Set the length of this ByteData object without re-allocating the underlying
	 * array. It is not possible to set the length larger than the underlying byte
	 * array.
	 */
