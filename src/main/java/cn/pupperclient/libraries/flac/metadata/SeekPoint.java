...
public class SeekPoint {
	...
	protected long streamOffset; // The offset, in bytes, of the target frame with respect to beginning of the
									// first frame.
	 ...
	 * @param streamOffset The offset, in bytes, of the target frame with respect to
